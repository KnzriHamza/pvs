                                    ...
                                    @php
                                                ...
                                                <li class="timeline-event">
                                                  ...
                                                  <div class="card timeline-event-card">
                                                    <div class="card-body">
                                                      <div class="text-secondary float-end">{{$message->date_created}}</div>
                                                      <h4>{{$message->message}}</h4>
                                                      <p class="text-secondary">{{$message->response}}</p>
                                                    </div>
                                                  </div>
                                                </li>
            ...
            <div class="col-md-4">
              ...
              <form action="{{ route('whatsapp') }}" method="GET">
                <div class="card-body">
                  ...
                  <div class="input-icon">
                    <textarea rows="3" name="message" class="form-control" placeholder="Ask your QUestion In here" ></textarea>
                    <span class="input-icon-addon">
